 ...
 * @since 2.0.0
 */
@protocol AddressBookApplicationDelegate <NSObject>
 ...
 * @since 2.0.0
 */
-(void)retrieveSucceeded:(NSMutableArray *) addressBook;
 ...
 * @since 2.0.0
 */
-(void)retrieveFailed:(MobileError *) error;
/**
 ...
 * @since 2.0.0
 */
-(void)searchDirectoryFailed:(MobileError *) error;
