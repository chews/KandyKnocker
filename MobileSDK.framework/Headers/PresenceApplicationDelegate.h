 ...
 * @since 2.0.0
 */
@protocol PresenceApplicationDelegate <NSObject>
 ...
 * @since 2.0.0
 */
- (void) retrieveSucceeded:(NSMutableArray *) presenceList;
 ...
 * @since 2.0.0
 */
- (void) retrieveFailed:(NSMutableArray *) presenceList withError:(MobileError *) error;
 ...
 * @since 2.0.0
 */
- (void) startWatchSucceeded:(NSMutableArray *) presenceList;
 ...
 * @since 2.0.0
 */
- (void) startWatchFailed:(NSMutableArray *)presenceList withError:(MobileError *) error;
 ...
 * @since 2.0.0
 */
- (void) stopWatchSucceeded:(NSMutableArray *) presenceList;
 ...
 * @since 2.0.0
 */
- (void) stopWatchFailed:(NSMutableArray *) presenceList withError:(MobileError *)error;
 ...
 * @since 2.0.0
 */
- (void) updatePresenceFailed:(MobileError *) error;
 ...
 * @since 2.0.0
 */
- (void) presenceStateChanged :(id<PresenceDelegate>) presence;
