...
#import "AddressBookSearchType.h"
#import "AddressBookApplicationDelegate.h"

/**
 * @brief This class represents a service for addressbook and directory.
 * @since 2.0.0
 */
@protocol AddressBookServiceDelegate <NSObject>
 ...
 * @since 2.0.0
 */
-(void) setAddressBookApplication:(id <AddressBookApplicationDelegate>) app;
...
- (void)searchDirectory:(NSString *)criteria
                      andSearchType:(AddressBookSearchTypes)searchType;
